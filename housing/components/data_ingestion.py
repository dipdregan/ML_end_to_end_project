...
import tarfile # this module will help us to extract  the zip file
from six.moves import urllib # this help us to dounload the file 
import pandas as pd 
import numpy as np
...
class DataIngestion:
    ...
    def download_housing_data(self) ->str:
        try:
            ...
            logging.info(f"File :[{housing_file_name}] has been downloaded successfully. ")
